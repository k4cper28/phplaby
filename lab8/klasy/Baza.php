...
//    }
    ...
    public function selectUserById($userId, $tableName)
    {
        // Perform a database query to retrieve user data based on the user ID
        $query = "SELECT * FROM logged_in_users WHERE userId = $userId"; // Replace 'id' with your actual user ID column name

        $result = $this->mysqli->query($query);

        // Check if the query was successful and return the user data or false if not found
