            ...
            if (filter_input(INPUT_POST, "submit")) {
                ...
                switch ($akcja) {
                    ...
                    case "pokaz" :
                        ...
                        break;
                    case "php" :
                        echo $bd->select("SELECT Nazwisko,Zamowienie FROM klienci WHERE FIND_IN_SET('PHP', `Zamowienie`)", ["Nazwisko", "Zamowienie"]);
                        break;
                    case "java" :
                        echo $bd->select("SELECT Nazwisko,Zamowienie FROM klienci WHERE FIND_IN_SET('Java', `Zamowienie`)", ["Nazwisko", "Zamowienie"]);
                        break;
                    case "cpp" :
                        echo $bd->select("SELECT Nazwisko,Zamowienie FROM klienci WHERE FIND_IN_SET('CPP', `Zamowienie`)", ["Nazwisko", "Zamowienie"]);
                        break;
                    case "statystki" :
                        statystyka($bd);
                        break;
